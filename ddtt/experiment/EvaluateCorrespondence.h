...
struct EvaluateCorrespondence
{
	...
	static double evaluate_compensate(Structure::ShapeGraph * shapeA, Structure::ShapeGraph * shapeB, Energy::SearchNode * searchNode, Energy::GuidedDeformation * egd);
	static double evaluate_top(Structure::ShapeGraph * shapeA, Structure::ShapeGraph * shapeB, Energy::SearchNode * searchNode);
	// Utility:
	...
	static NanoKdTree* kdTreeShape(Structure::ShapeGraph* shape);
